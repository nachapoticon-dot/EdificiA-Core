...
const envSchema = z.object({
  ...
  DATABASE_URL: z.string().min(1, "es requerida (PostgreSQL propio, ver docker-compose.yml)"),
  AUTH_JWT_SECRET: z.string().min(32, "es requerida (mínimo 32 chars; generar con: openssl rand -base64 48)"),
  ...
  PASSWORD_RESET_SECRET: z.string().optional(), // cae a AUTH_JWT_SECRET
