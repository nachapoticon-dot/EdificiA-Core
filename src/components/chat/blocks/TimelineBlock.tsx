      ...
      <div className="grid grid-cols-[200px_1fr] gap-3 border-b border-dashed border-border pb-1.5">
        ...
        <div className="relative flex items-end">
          ...
          >
            ...
            <span
              className="absolute -left-4 -top-4 rounded-[3px] bg-[var(--warn)] px-1.5 py-px font-mono text-[9px] font-bold tracking-[0.08em]"
              style={{ color: "var(--paper-950, #1a1a1a)" }}
            >
              HOY
            </span>
          </div>
      ...
      <div className="flex flex-col">
        {phases.map((p, i) => {
          ...
          return (
            <div
              key={i}
              className="grid grid-cols-[200px_1fr] items-center gap-3 border-b border-dashed border-white/[0.05] py-1.5 last:border-b-0"
            >
              ...
              <div
                ...
                style={{
                  background:
                    "repeating-linear-gradient(to right, transparent 0, transparent calc(100% / 7 - 1px), oklch(1 0 0 / 0.04) calc(100% / 7 - 1px), oklch(1 0 0 / 0.04) calc(100% / 7))",
                }}
              >
                <div
                  className={cn(
                  ...
                  style={{
                    ...
                    color: "var(--paper-950, #1a1a1a)",
                  }}
                >
                  {/* Progress fill */}
                  <div
                    className="absolute inset-y-0 left-0 border-r-2 border-white/40 bg-black/25"
                    style={{ width: status === "pending" ? "0%" : `${done}%` }}
                  />
