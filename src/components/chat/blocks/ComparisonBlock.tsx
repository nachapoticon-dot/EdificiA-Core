            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isRec && "-mx-3.5 bg-primary/5 px-3.5"
                )}
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2 text-[12px] font-semibold">
                      ...
                      {isRec && (
                        <span
                          className="inline-flex items-center gap-1 rounded-[3px] px-1.5 py-0.5 font-mono text-[9px] tracking-[0.08em] text-primary-foreground"
