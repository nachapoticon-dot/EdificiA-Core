...
## Documentos de arquitectura y visión

| Archivo | Contenido | Cuándo leerlo |
|---------|-----------|---------------|
| [01_vision_and_stack.md](./01_vision_and_stack.md) | Filosofía del producto, stack tecnológico | Para entender el "por qué" del proyecto |
| [02_phases_and_workflow.md](./02_phases_and_workflow.md) | Estado actual de los sprints (todos completados) | Para saber qué ya está hecho |
