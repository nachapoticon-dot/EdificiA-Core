-- =============================================================
-- Migración 016: Audit log inmutable
-- Registro append-only para eventos legales/operativos.
-- =============================================================
...
-- Sin policies INSERT/UPDATE/DELETE: el cliente no escribe ni muta el log.
-- El server usa service-role; los triggers igualmente bloquean UPDATE/DELETE.
